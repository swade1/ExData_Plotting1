...
#generate top left line graph
plot(f$DateTime,f$Global_active_power,ylab="Global Active Power",type="l",xlab="")

#generate top right graph 
plot(f$DateTime,f$Voltage,ylab="Voltage",type="l",xlab="datetime")
...
# add legend
legend("topright", y.intersp=0.6, bty="n", text.width = strwidth(text)[1]*1.25, lwd=1, col=c("black","red","blue"), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),x.intersp=0.5)

# generate bottom right graph 
plot(f$DateTime,f$Global_reactive_power,ylab="Global_reactive_power",type="l",xlab="datetime")
